...
/**
 * If annotation exists, this config will not be synced to the client upon connection to a server. Has no effect is this field is not also annotated with {@link Config}.
 * <p>
