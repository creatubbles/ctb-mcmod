...
/**
 * Represents the range a config value can be, i.e. a minimum and maximum value. This is applied forcefully, any value past one of the extremes will be clamped inside this range. Has no effect is this
