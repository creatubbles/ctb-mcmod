...
import com.creatubbles.repack.endercore.common.config.RestartReqs;

/**
 * Represents the restart requirements of a config value. Use this if your config will have no effect if changed while the game is running. Has no effect is this field is not also annotated with
 * {@link Config}.
 */
